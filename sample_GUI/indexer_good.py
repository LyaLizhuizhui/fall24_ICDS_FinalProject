...
class PIndex(Index):
    def __init__(self, name):
        super().__init__(name)
        roman_int_f = open('E:/NYUSH/24Fall/ICDS/Code/fall24_ICDS_FinalProject/sample_GUI/roman.txt.pk', 'rb')
...
if __name__ == "__main__":
    sonnets = PIndex("E:/NYUSH/24Fall/ICDS/Code/fall24_ICDS_FinalProject/sample_GUI/AllSonnets.txt")
