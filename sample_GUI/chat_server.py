#E:/NYUSH/24Fall/ICDS/Code/fall24_ICDS_FinalProject/sample_GUI/chat_server.py
import time
import socket
import select
import sys
...
class Server:
    def __init__(self):
        ...
        # self.sonnet_f.close()
        self.sonnet = indexer_good.PIndex("E:/NYUSH/24Fall/ICDS/Code/fall24_ICDS_FinalProject/sample_GUI/AllSonnets.txt")
